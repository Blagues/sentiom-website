    ...
    const translations = {
        nl: {
            ...
            section: {
                ...
                insight_p: 'Sentiom volgt doorlopend wat er speelt binnen uw gemeente. Social media en nieuws worden met AI samengebracht in één overzicht, met dagelijkse rapportages en automatisch gegenereerde verdiepingsrapporten. Zo beschikt u altijd over actuele context voor onderbouwde beleidskeuzes, zonder handmatig zoekwerk.',
                closer_h2: 'Privacy-first',
                closer_p: 'Privacy was geen bijzaak, maar een uitgangspunt. Sentiom is vanaf het begin ontwikkeld met oog op de AVG: analyses op geanonimiseerde data, geen opslag van persoonsgegevens en volledige transparantie over wat er gebeurt met uw data.',
                closer_link: 'Hoe doen wij dat? →',
                partners_label: 'Wij werken samen met',
            },
            product: {
                daily_h2: 'Dagelijkse Updates',
                daily_p: 'Volg doorlopend het nieuws en ontdek welke onderwerpen er spelen. Kies de thema\'s die voor u relevant zijn, en laat AI er elke dag automatisch een overzichtelijke, AVG-veilige update van maken die direct deelbaar is binnen uw organisatie.',
                daily_btn: 'Bekijk deze update \u2192',
                reports_h2: 'Automatisch Rapporten Genereren',
                reports_p: 'Wilt u een onderwerp verder uitdiepen? Met één klik genereert u een volledig rapport, direct inzetbaar binnen de gemeente. Geen handmatig zoekwerk meer. Wij aggregeren alle comments en slaan geen verdere persoonsgegevens op. Analyses worden uitgevoerd op geanonimiseerde data.',
        ...
        en: {
            ...
            section: {
                ...
                insight_p: 'Sentiom continuously monitors what\'s happening in your municipality. Social media and news are brought together with AI in one clear overview, with daily reports and automatically generated in-depth analyses. So you always have up-to-date context for informed policy decisions, without any manual searching.',
                closer_h2: 'Privacy-first',
                closer_p: 'Privacy was not an afterthought, it was the starting point. Sentiom has been built from the start with GDPR compliance at its core: analyses on anonymised data, no storage of personal data, and full transparency about how your data is handled.',
                closer_link: 'How do we do it? →',
                partners_label: 'We work together with',
            },
            product: {
                daily_h2: 'Daily Updates',
                daily_p: 'Stay on top of the news and discover which topics are trending. Choose the themes that matter to you, and let AI automatically create a clear, GDPR-compliant daily update that is instantly shareable within your organisation.',
                daily_btn: 'View this update \u2192',
                reports_h2: 'Automatically Generate Reports',
                reports_p: 'Want to dive deeper into a topic? With one click, you generate a complete report, ready to use within your municipality. No more manual research. We aggregate all comments and do not store any further personal data. Analyses are performed on anonymised data.',
